...
class Settings(BaseSettings):
    ...
    mem0_embedder_provider: str = Field(default="fastembed", validation_alias="MEM0_EMBEDDER_PROVIDER")
    mem0_embedder_model: str = Field(default="BAAI/bge-small-en-v1.5", validation_alias="MEM0_EMBEDDER_MODEL")
